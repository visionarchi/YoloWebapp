...
detector = YoloDetector(model_name=r"C:\Users\rohin\Desktop\pythonProject\yolov5n.pt")
...
while cap.isOpened():
    ...
    img, detections = detector.plot_boxes(results, img, height=img.shape[0], width=img.shape[1], confidence=0)

    tracks = object_tracker.update_tracks(detections,
                                          frame=img)  # bbs expected to be a list of detections, each in tuples of ( [left,top,w,h], confidence, detection_class )
